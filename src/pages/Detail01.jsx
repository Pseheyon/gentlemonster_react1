        ...
        <h1>Detail01</h1>
            <section className="de_ab">
                <div className="container top">
                    <div className="left">
                        <img className="img1" src="../img/detail/black_01.png" alt="product" />
                        <img className="img2" src="../img/detail/black_02.png" alt="product" />
                        <img className="img3" src="../img/detail/black_03.png" alt="product" />
                        <img className="img4" src="../img/detail/black_04.png" alt="product" />

                        <img className="img5" src="../img/detail/bag.png" alt="product" />

                    </div>
                    <div className="right">
                        <div className="name"> <span><strong>론디01</strong></span><span>259,000원</span></div>
                        <ul className="min_products">
                             <li><img src="../img/detail/con_sun01.png" alt="orange" /></li>
                            <li><img src="../img/detail/black.png" alt="black" /></li>
                            {/*
